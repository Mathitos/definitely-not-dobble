defmodule DefinitelyNotDobble.Application do
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: DefinitelyNotDobble.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    DefinitelyNotDobbleWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
